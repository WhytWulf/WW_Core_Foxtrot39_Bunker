Assets {
  Id: 1114023924849317102
  Name: "Vinyl Record Electronic 6"
  PlatformAssetType: 5
  TemplateAsset {
    ObjectBlock {
      ...
      Objects {
        ...
        Name: "Vinyl Record Electronic 3"
        Transform {
          Scale {
            X: 1
            Y: 1
      ...
      Objects {
        ...
        Trigger {
          Interactable: true
          InteractionLabel: "Pick up Parkour City"
          TeamSettings {
      ...
      Objects {
        ...
        UnregisteredParameters {
          Overrides {
            Name: "bp:Type"
            Enum {
              Value: "mc:emx_electronicmusic:50"
            }
          }
        }
        Collidable_v2 {
