Assets {
  Id: 8657014345550129892
  Name: "Vinyl Record Electronic 8"
  PlatformAssetType: 5
  TemplateAsset {
    ObjectBlock {
      ...
      Objects {
        ...
        Name: "Vinyl Record Electronic 7"
        Transform {
          Scale {
            X: 1
            Y: 1
        ...
        UnregisteredParameters {
          Overrides {
            Name: "cs:Music"
            ObjectReference {
              SubObjectId: 9949826197817201247
            }
          }
          Overrides {
            Name: "cs:Record"
      ...
      Objects {
        ...
        Trigger {
          Interactable: true
          InteractionLabel: "Pick up Share the Wub"
          TeamSettings {
      ...
      Objects {
        ...
        UnregisteredParameters {
          Overrides {
            Name: "bp:Type"
            Enum {
              Value: "mc:emx_electronicmusic:46"
            }
          }
        }
        Collidable_v2 {
